...
description: '''In this project, I have analysed the impact of COVID-19 on Tfl bike
  travel as part of my Data Analytics for Finance course at London Business School.'''
draft: no
image: bikes.jpg
keywords: ''
slug: tflbikes
...
```{r tfl_month_year_gr, out.width="100%"}
knitr::include_graphics(here::here("/img/tfl.png"), error = FALSE)
```

We can already see the high level impact COVID-19 has had on Tfl Bike travel. 
